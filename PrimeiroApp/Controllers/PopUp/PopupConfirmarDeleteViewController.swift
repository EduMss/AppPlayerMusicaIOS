//
//  PopupConfirmarDeleteViewController.swift
//  PrimeiroApp
//
//  Created by Eduardo Matheus on 21/11/23.
//

import UIKit

class PopupConfirmarDeleteViewController: UIViewController {
    ...
    var MusicasViewControl: MusicasViewController!
    
    func setMusicaViewControl(musicaViewControl:MusicasViewController){
        self.MusicasViewControl = musicaViewControl
    }
    ...
    @objc func BotaoDeletarFunc(){
        self.MusicasViewControl.ConfirmarDelete(tag: self.Tag)
